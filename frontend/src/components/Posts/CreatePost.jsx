...
const CreatePost = () => {
  ...
  return (
    <div className="flex items-center justify-center">
        <div className="max-w-md w-fullbg-white rounded-lg shadow-md p-8 m-4">
            ...
            <form onSubmit={formik.handleSubmit} className="space-y-6">
                ...
                {/* {imagePreview && (
                    <div className="mt-2 relative">
                        ...
                        <button
                            ...
                            -translate-y-1/2 bg-white rounded-full p-1"
                        >
                ...
                <button
                    ...
                    from-orange-500 to-orange-500 hover:from-indigo-600
                    hover:to-blue-600 focus: outline-nonecfocus: ring-2
