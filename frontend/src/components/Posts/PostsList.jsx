    ...
    <div className="container px-4 mx-auto">
            ...
            {data?.posts?.map ((post) => (
             <div key={post._id} className="w-full md:w-1/2 lg:w-1/3 p-4">
                  <Link to={`/posts/${post._id}`}>
                      ...
                      hoverLborder-orange-500 transition duartion-200 rounded-2xl
                      h-full p-3">
                          <div className="relative" style={{ height: 240 }} >
                              <div className="absolute top-0 left-0 z-10"></div>
                              <div className="absolute bootom-0 right-0 z-10"></div>
                              {/*<img
                              ...
                              <div className="pt-6 pb-3 px-4">
                                  ...
                                  <div className="flex flex-wrap items-center gap-3">
                                      ...
                                      <div clssName="py-1 px-2 rounded-md border
                                      border-gray-100 yexy-xs font-medium text-gray-700
                                      inline-block">
                                          {post?.categroy?.categoryName}
                                      </div>
                                  </div>
                              </div>
                          </div>
        ...
        {/*<div className="flex justify-center items-center my-8 space-x-4">
         ...
         <button onClick={() => handlePageChange(page - 1)}
          ...
          <span>
            Page {page} of {postData?.totalPages}
          </span>
