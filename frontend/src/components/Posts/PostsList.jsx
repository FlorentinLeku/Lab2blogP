  ...
  return (
    <section className="overflow-hidden">
      <div className="container px-4 mx-auto">
        ...
        >
          <div className="flex-grow flex items-center border border-gray-300 
          ...
          <button
            ...
            className="p-2 text-sm text-orange-500 border border-blue-500 rounded-lg 
          ...
          {data?.posts?.map((post) => (
            <div key={post._id} className="w-full md:w-1/2 lg:w-1/3 p-4">
              <Link to={`/posts/${post._id}`}>
                <div className="bg-white border border-gray-100 hover:border-orange-500 
                transition duration-200 rounded-2xl h-full p-3">
                  ...
                  <div className="pt-6 pb-3 px-4">
                    ...
                    <div className="flex flex-wrap items-center gap-3">
                      ...
                      <div className="py-1 px-2 rounded-md border border-gray-100 text-xs 
                      font-medium text-gray-700 inline-block">
      ...
      <div className="flex justify-center items-center my-8 space-x-4">
        {page > 1 && (
          <button
            ...
            hover:bg-blue-600 focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-50"
          >
            Previous
          </button>
        )}
