      ...
      <div className="container px-4 mx-auto relative">
        <div className="relative z-20">
          ...
          <div className="flex justify-center lg:pb-56">
            <Link
              to="/register"
              className="w-full sm:w-auto h-16 inline-flex items-center 
              justify-center text-center py-4 px-6 rounded-full bg-orange-600 
              border border-orange-700 shadow font-bold font-heading text-white 
              hover:bg-orange-800 focus:ring focus:ring-blue-200 transition duration-200"
            >
              Get Started
            </Link>
          </div>
