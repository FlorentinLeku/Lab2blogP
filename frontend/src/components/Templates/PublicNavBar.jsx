        ...
        <Disclosure as="nav" className="bg-white shadow">
            ...
            {({ open }) => (
                    ...
                    <div className="flex h-16 justify-between">
                        <div className="flex">                            
                            <div className="-ml-2 mr-2 flex items-center md:hidden">
                                ...
                                items-center justify-center rounded-md p-2 text-gray-400
                    ...
                    <div className="flex items-center">
                        <div className="flex-shrink-0">
                            <Link
                                ...
                                focus-visible: outline-indigo-600 animate-pulse"
                            >
                                <PlusIcon className="-ml-0.5 h-5 w-5" aria-hidden="true" />
                                Create Post
                            </Link>
                        </div>
                            <div className="hidden md:ml-4 md:flex md: flex-shrink-0
                            md:items-center">
                                <button
                                    type="button"
                                    className="relative rounded-full bg-white p-1 text-gray-400
                                    hover: text-gray-500 focus: outline-none focus:ring-offset-2
                ...
                <div className="space-y-1 pb-3 pt-2">               
                    ...
                    Default: "border-transparent text-gray-500 hover:bg-gray-50 
                    ...
                    <Disclosure.Button       
                        ...
                        text-base font-medium text-gray-500 hover:border-gray-300
                        hover:bg-gray-50 hover: text-gray-700 sm:pl-5 sm:pr-6"
                    >
                        Home
                    </Disclosure.Button>
                    <Disclosure.Button       
