            ...
            <div className="flex h-16 justify-start items-center">
              <div className="flex justify-center flex-row w-full">
                <div className="-ml-2 mr-2 flex items-left md:hidden">
                  ...
                  justify-center rounded-md p-2 text-gray-400 hover:bg-gray-100 
              ...
              <div className="flex items-center">
                <div className="flex-shrink-0">
                  <button
                    ...
                    type="button"
                    className="relative m-2 inline-flex items-center gap-x-1.5 rounded-md 
                    bg-red-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 
                  ...
                  <Link to="/dashboard">
                    <button
                      type="button"
                      className="relative mr-1 inline-flex items-center gap-x-1.5 rounded-md 
                      bg-orange-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 
          ...
          <Disclosure.Panel className="md:hidden">
            <div className="space-y-1 pb-3 pt-2">
              <Link to="/">
                <Disclosure.Button
                  as="button"
                  className="block border-l-4 border-transparent py-2 pl-3 pr-4 text-base 
                  font-medium text-gray-500 hover:border-gray-300 hover:bg-gray-50 
                  hover:text-gray-700 sm:pl-5 sm:pr-6"
                >
                  Home
                </Disclosure.Button>
              </Link>
              <Link to="/posts">
                <Disclosure.Button
                  as="button"
                  className="block border-l-4 border-transparent py-2 pl-3 pr-4 
                  text-base font-medium text-gray-500 hover:border-gray-300 hover:bg-gray-50 
                  hover:text-gray-700 sm:pl-5 sm:pr-6"
                >
                  Latest Posts
                </Disclosure.Button>
              ...
              <div className="mt-3 space-y-1">
                <Link to="/dashboard/settings">
                  <Disclosure.Button
                    ...
                    hover:bg-gray-100 hover:text-gray-800 sm:px-6"
                  >
                    Settings
                  </Disclosure.Button>
                </Link>
