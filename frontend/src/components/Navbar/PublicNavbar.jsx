              ...
              <div className="flex items-center">
                <div className="flex-shrink-0">
                  <Link
                    ...
                    bg-orange-600 px-3 py-2 text-sm font-semibold text-white shadow-sm 
                    hover:bg-orange-600 focus-visible:outline focus-visible:outline-2 
                    focus-visible:outline-offset-2 focus-visible:outline-indigo-600 animate-pulse"
                  >
          ...
          <Disclosure.Panel className="md:hidden">
            <div className="space-y-1 pb-3 pt-2">
              ...
              <Disclosure.Button
                ...
                pr-4 text-base font-medium text-gray-500 hover:border-gray-300 
